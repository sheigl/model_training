...
cd $BASE_DIR
$PYTHON -m training_data.generate_synthetic_data.main --combo-queries $NUM --model $MODEL --validation-model $VALIDATION_MODEL --validation-pct $VALIDATION_PCT --enable-observer
